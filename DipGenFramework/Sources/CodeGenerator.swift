...
extension String {
    ...
    public init(containers: FileProcessingResult, files: [File]) {
        ...
        let configureAll = Template.configureAll(containers: Array(containers.keys))
        let bootstrapAll = Template.bootstrapAll(containers: Array(containers.keys))
        let extensionMethods = Template.containerExtension([configureAll, bootstrapAll]).description()
        ...
        self = "\(comment)\(Set(imports).joinWithSeparator("\n"))\n\n\(content)\n\n\(extensionMethods)"
    }
